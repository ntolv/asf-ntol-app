          ...
          <section className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-6">
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                <p className="text-xs font-medium uppercase tracking-wide text-slate-500">Rubriques total</p>
                <p className="text-lg font-bold text-slate-900">
                  {bloc3.nb_rubriques}
                </p>
                <p className="text-xs text-slate-500">
                  {bloc3.nb_rubriques > 1 ? "rubriques" : "rubrique"}
                </p>
              </div>

              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                <p className="text-xs font-medium uppercase tracking-wide text-slate-500">À jour</p>
                <p className="text-lg font-bold text-slate-900">
                  {bloc3.nb_a_jour}
                </p>
                <p className="text-xs text-slate-500">
                  {bloc3.nb_a_jour > 1 ? "rubriques" : "rubrique"}
                </p>
              </div>

              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                <p className="text-xs font-medium uppercase tracking-wide text-slate-500">À payer</p>
                <p className="text-lg font-bold text-slate-900">
                  {formatMontant(bloc3.nb_a_payer)}
                </p>
                <p className="text-xs text-slate-500">
                  {bloc3.nb_a_payer > 1 ? "rubriques" : "rubrique"}
                </p>
              </div>

              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                <p className="text-xs font-medium uppercase tracking-wide text-slate-500">Partiel</p>
                <p className="text-lg font-bold text-slate-900">
                  {formatMontant(bloc3.nb_partiel)}
                </p>
                <p className="text-xs text-slate-500">
                  {bloc3.nb_partiel > 1 ? "rubriques" : "rubrique"}
                </p>
              </div>

              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                <p className="text-xs font-medium uppercase tracking-wide text-slate-500">En retard</p>
                <p className="text-lg font-bold text-slate-900">
                  {bloc3.nb_en_retard}
                </p>
                <p className="text-xs text-slate-500">
                  {bloc3.nb_en_retard > 1 ? "rubriques" : "rubrique"}
                </p>
              </div>

              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                <p className="text-xs font-medium uppercase tracking-wide text-slate-500">Non paramétré</p>
                <p className="text-lg font-bold text-slate-900">
                  {bloc3.nb_non_parametre}
                </p>
                <p className="text-xs text-slate-500">
                  {bloc3.nb_non_parametre > 1 ? "rubriques" : "rubrique"}
                </p>
              </div>
                ...
                <div className="flex min-w-[180px] flex-col items-end gap-2">
                  <div className="h-2 w-full rounded-full bg-slate-200">
                    <div
                      ...
                      style={{ width: `${Math.max(0, Math.min(100, Number(bloc3.progression_pct || 0)))}%` }}
                    />
                  </div>
                  <p className="text-xs text-slate-500">{Math.max(0, Math.min(100, Number(bloc3.progression_pct || 0)))}% payé</p>
                </div>
              </div>

              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                <p className="text-xs font-medium uppercase tracking-wide text-slate-500">Statut global</p>
                <p className="text-lg font-bold text-slate-900">
                  {bloc3?.statut_global || "Non défini"}
                </p>
                <p className="text-xs text-slate-500">
                  Statut global : {bloc3.statut_global}
                </p>
              </div>
            </div>
          </section>
